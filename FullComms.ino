...
//"MEO-755250";
//"adf1dc6a34";
//"Vodafone Biana 2.4GHz";
//"93EA6D7HXDTFFG3E";

//to do: 
      //dar fix aos espaços da web que veem com + da web, no ssid tem que ter espaço DONE
      // dar display dos ssids da rede na pagina web DONE
      //separar em funcaos DONE?
      //ler pedidos xml
      //testar perda de wifi no estado 2 DONE
      //handshake com a app, app manda broadcast, pico mando o seu ip
